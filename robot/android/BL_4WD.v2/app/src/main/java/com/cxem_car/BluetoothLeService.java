...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.cxem_car.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.cxem_car.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.cxem_car.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.cxem_car.ACTION_DATA_AVAILABLE";
    public final static String ACTION_DATA_WRITTEN =
            "com.cxem_car.ACTION_DATA_WRITTEN";
    public final static String EXTRA_DATA =
            "com.cxem_carEXTRA_DATA";
    ...
    public boolean connect(final String address) {
        ...
        // NEW: Check for BLUETOOTH_CONNECT permission on Android 12+
     ...
     * asynchronously through the {@code BluetoothGattCallback#onCharacteristicWrite(android.bluetooth.BluetoothGatt,
     * android.bluetooth.BluetoothGattCharacteristic, int)} callback.
     *
     * @param characteristic The characteristic to read from.
     */
